...
export const StaffResolvedIssues = () => {
  ...
  // Mock data representing resolved issues fetched via getAssignedIssues with { status: 'resolved' }
  const resolvedIssues = [
    {
      _id: "issue_089",
      description:
        "Replaced the cracked PVC trap under the sink in the G-Floor washroom.",
      category: "Plumbing",
      location: "Main Library, G-Floor Washroom",
      reportedBy: { fullName: "Jane Doe" },
      resolvedAt: "2026-10-10T14:30:00Z",
    },
    {
      _id: "issue_075",
      description: "Fixed the broken door hinge on the main entrance.",
      category: "Carpentry",
      location: "Block C, Entrance",
      reportedBy: { fullName: "Mark Johnson" },
      resolvedAt: "2026-10-08T09:15:00Z",
    },
  ];
